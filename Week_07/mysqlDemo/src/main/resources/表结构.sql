...
alter TABLE address COMMENT = '地址'  ENGINE=InnoDB DEFAULT CHARSET=utf8;
	...
	ALTER TABLE address MODIFY COLUMN  `create_time` BIGINT NOT NULL COMMENT '创建时间';
		
	ALTER TABLE address MODIFY COLUMN  `change_time` BIGINT NOT NULL COMMENT '修改时间';
...
alter TABLE area COMMENT = '区域'  ENGINE=InnoDB DEFAULT CHARSET=utf8;
	...
	ALTER TABLE area MODIFY COLUMN  `create_time` BIGINT NOT NULL COMMENT '创建时间';
		
	ALTER TABLE area MODIFY COLUMN  `change_time` BIGINT NOT NULL COMMENT '修改时间';
...
alter TABLE order_product COMMENT = '订单商品'  ENGINE=InnoDB DEFAULT CHARSET=utf8;
	...
	ALTER TABLE order_product MODIFY COLUMN  `price` INTEGER NOT NULL COMMENT '价格_分';
...
alter TABLE product_type COMMENT = '商品分类'  ENGINE=InnoDB DEFAULT CHARSET=utf8;
 
	ALTER TABLE product_type MODIFY COLUMN  `product_type_id` BIGINT AUTO_INCREMENT COMMENT '商品分类ID';
		
	ALTER TABLE product_type MODIFY COLUMN  `name` VARCHAR(32) NOT NULL COMMENT '名称';
		
	ALTER TABLE product_type MODIFY COLUMN  `create_time` BIGINT NOT NULL COMMENT '创建时间';
		
	ALTER TABLE product_type MODIFY COLUMN  `change_time` BIGINT NOT NULL COMMENT '修改时间';
...
alter TABLE sku COMMENT = 'sku'  ENGINE=InnoDB DEFAULT CHARSET=utf8;
	...
	ALTER TABLE sku MODIFY COLUMN  `no` INTEGER NOT NULL COMMENT '数量';
		
	ALTER TABLE sku MODIFY COLUMN  `stock_state` INTEGER NOT NULL COMMENT '存货状态';
...
alter TABLE spu COMMENT = 'spu'  ENGINE=InnoDB DEFAULT CHARSET=utf8;
	...
	ALTER TABLE spu MODIFY COLUMN  `product_type_id` BIGINT NOT NULL COMMENT '商品分类ID';
